...
join(arr,"-")=${fn:join(arr,"-")} : 
      arr 배열의 요소를 -으로 연결하여 하나의 문자열로 리턴<br>
<c:set var="str3" value="${fn:trim(str1)}" />      
length(trim(str1)) : ${fn:length(str3)}<br>
